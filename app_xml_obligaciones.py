...
if xls_file:
    if st.button("Generar XML obligaciones nuevas"):
        st.markdown(
        ...
        with st.form("form_parametros"):
            ...
            fecha_Desembolso = st.date_input(" ", value=date.today())
            ...
            cod_programa = st.text_input(" ", value="501")
            ...
            cod_intermediario = st.text_input(" ", value="203018")
            ...
            tipo_plan_checkbox = st.checkbox(" ", key="tipo_plan_checkbox")

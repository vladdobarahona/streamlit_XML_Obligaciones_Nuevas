...
fecha_Desembolso = st.date_input(
    "Indicar fecha de desembolso:",
    value=date(2025, 5, 9)
)

# Código del programa
cod_programa = st.text_input(
    "Indicar código del programa:",
    value="126"
)

# Código del intermediario
cod_intermediario = st.text_input(
    "Indicar código del intermediario:",
    value="203018"
)

# Tipo de plan
tipo_plan_checkbox = st.checkbox("¿Es un plan tipo bullet?")
...
#falta traer código programa
#falta traer código de intermediario
